...
const ContactLayout = () => {
  ...
  const contactMethods = [
    {
      icon: Mail,
      title: "Email",
      value: "swapnil.ranadive101@gmail.com",
  ...
  return (
    <div className=" bg-black text-white flex flex-col overflow-x-hidden">
      ...
      <div
        id="contact"
        className="bg-gradient-to-b bg-transparent text-zinc-400 pt-12"
      >
                    ...
                    <div key={index} className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        {method.href ? (
                          ...
                          <p className="text-white text-2xl">{method.value}</p>
                        )}
                      </div>
                    </div>
                  ))}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-0 py-3 text-xl border-0 border-b border-gray-300 focus:border-white focus:outline-none transition-colors duration-200 bg-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={5}
                    className="w-full px-0 py-3 text-xl border-0 border-b border-gray-300 focus:border-white focus:outline-none transition-colors duration-200 bg-transparent resize-none"
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full bg-black text-xl border-zinc-200 text-white py-4 px-6 hover:bg-zinc-500 hover:text-black transition-colors duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
